...
@php
    $metaTitle = 'NYG Transporte — Logística inteligente y control absoluto | Argentina';
    $metaDescription = 'Coordinamos transporte, almacenamiento y distribución a nivel nacional. Monitoreo satelital 24/7, atención personalizada y máxima precisión operativa.';
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card-compact">
                        ...
                        <div class="service-body">
                            ...
                            <a href="{{ route('servicios.show', $service) }}" class="service-link">
                                Ver detalles
                ...
                <div id="ops-view-rendimiento">
                    <div class="logistics-process-desktop d-none d-lg-block">
                        <div class="process-interactive-wrapper">
                            ...
                            <!-- Left Column: Steps 01, 02, 03 (Texts & Lines) -->
                            ...
                            <div class="process-center-circle-area">
                                ...
                                <!-- Interactive Circular Buttons positioned on middle circle (r=170) -->
                            ...
                            <!-- Right Column: Steps 04, 05, 06 (Texts & Lines) -->
                    ...
                    {{-- Versión Móvil: Línea Vertical Elegante --}}
...
{{-- 7. CLIENTES (DESAPARECEN Y APARECEN) --}}
...
<section class="section-dark section-clients py-5" data-animate>
    <div class="container">
        ...
        <div class="logo-groups-wrapper">
            @foreach($clients->chunk(6) as $index => $group)
                <div class="logos-fade-group @if($index === 0) active @endif" id="logo-group-{{ $index + 1 }}" style="@if($index > 0) display: none; @else display: flex; @endif">
                    @foreach($group as $client)
                        <div class="logo-fade-item">
                            <img src="{{ $client->logo_url }}" alt="Logo de {{ $client->name }}" class="client-fade-logo" loading="lazy">
                        </div>
                    @endforeach
                </div>
            @endforeach
