...
try {
    ...
    $clients = [
        ...
        ['name' => 'Accenture', 'logo_url' => '/images/clients/accenture.svg', 'is_featured' => 1, 'is_active' => 1, 'sort_order' => 2],
        ['name' => 'Mercado Libre', 'logo_url' => '/images/clients/mercadolibre.png', 'is_featured' => 1, 'is_active' => 1, 'sort_order' => 3],
        ['name' => 'Ocasa', 'logo_url' => '/images/clients/ocasa.png', 'is_featured' => 1, 'is_active' => 1, 'sort_order' => 4],
        ['name' => 'Webpack', 'logo_url' => '/images/clients/webpack.png', 'is_featured' => 1, 'is_active' => 1, 'sort_order' => 5],
        ['name' => 'Welivery', 'logo_url' => '/images/clients/welivery.png', 'is_featured' => 1, 'is_active' => 1, 'sort_order' => 6],
    ];
