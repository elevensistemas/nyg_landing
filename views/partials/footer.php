    ...
    <div class="container">
        <div class="row gy-5">
            <div class="col-lg-4">
                ...
                <?php if($rnpsp): ?>
                    <p class="footer-text small text-muted">R.N.P.S.P <?= htmlspecialchars($rnpsp) ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="col-lg-3 col-6">
                ...
                <ul class="footer-list">
                    <li><?= htmlspecialchars(Setting::get('address')) ?></li>
                    <li><a href="mailto:<?= htmlspecialchars(Setting::get('contact_email')) ?>"><?= htmlspecialchars(Setting::get('contact_email')) ?></a></li>
                    <li><?= htmlspecialchars(Setting::get('contact_phone_display')) ?></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3">
                ...
                <div class="footer-social mt-3">
                    <?php if($facebook): ?>
                        <a href="<?= htmlspecialchars($facebook) ?>" target="_blank" rel="noopener" aria-label="Facebook de NYG Transporte">Facebook</a>
                    <?php endif; ?>
                    <?php if($instagram): ?>
                        <a href="<?= htmlspecialchars($instagram) ?>" target="_blank" rel="noopener" aria-label="Instagram de NYG Transporte">Instagram</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
