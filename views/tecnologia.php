...
$intro = $sectionsMap['intro'] ?? null;
?>
<section class="page-hero page-hero-dark" data-animate>
    <div class="container">
        <p class="eyebrow">Tecnología</p>
        <h1><?= htmlspecialchars($intro['title'] ?? 'Cada envío visible. Cada decisión respaldada.') ?></h1>
        <p class="lead-text lead-text-light"><?= nl2br(htmlspecialchars($intro['body'] ?? '')) ?></p>
    </div>
</section>
...
<section class="section-dark" data-animate>
    <div class="container">
        <div class="control-panel-mock" aria-hidden="true" style="background-image: url('<?= htmlspecialchars(Setting::get('hero_slide_3_image')) ?>'); min-height: 420px;">
